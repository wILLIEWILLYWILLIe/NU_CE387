// =============================================================
// deemphasis_tb.sv — Testbench for deemphasis.sv (Left channel)
// Reads: left_raw.txt → Compares: left_deemph.txt
// =============================================================

`timescale 1ns/1ps
import fir_pkg::*;

module deemphasis_tb;

    // -------------------------------------------------------
    // Test txt
    // -------------------------------------------------------
    localparam string IN_FILE     = "../../test/left_raw.txt";
    localparam string GOLDEN_FILE = "../../test/left_deemph.txt";

    localparam int N_SAMPLES  = 32768;    // AUDIO_SAMPLES = 262144/8
    ...
    initial begin
        $display("=== De-emphasis (Left) Testbench ===");
