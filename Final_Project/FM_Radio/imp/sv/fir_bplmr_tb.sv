// =============================================================
// fir_bplmr_tb.sv — FIR BP L-R (32-tap, decim=1)
// demod.txt → bp_lmr.txt
// =============================================================
...
module fir_bplmr_tb;
    ...
    localparam string GOLDEN_FILE = "../../test/bp_lmr.txt";

    localparam int TAPS  = BP_LMR_TAPS;
    ...
    initial begin
        $display("=== FIR BP L-R (32-tap, decim=1) Testbench ===");
        for (int i = 0; i < TAPS; i++) coeffs[i] = BP_LMR_COEFFS[i];
