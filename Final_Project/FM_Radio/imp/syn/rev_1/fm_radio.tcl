...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|fm_radio_top"
...
set_global_assignment -section_id fm_radio_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "fm_radio.scf"
