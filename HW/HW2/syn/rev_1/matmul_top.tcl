...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|matmul_top"
...
set_global_assignment -section_id matmul_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "matmul_top.scf"
