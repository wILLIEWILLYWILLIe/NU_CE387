...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|motion_detect_top"
...
set_global_assignment -section_id motion_detect_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "motion_detect_top.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "motion_detect_top" 
