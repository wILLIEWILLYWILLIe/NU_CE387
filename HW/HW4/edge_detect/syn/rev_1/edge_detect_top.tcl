...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|edge_detect_top"
...
set_global_assignment -section_id edge_detect_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "edge_detect_top.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "edge_detect_top" 
