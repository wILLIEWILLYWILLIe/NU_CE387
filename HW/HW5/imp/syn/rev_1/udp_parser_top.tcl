...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|udp_parser_top"
...
set_global_assignment -section_id udp_parser_top -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "udp_parser_top.scf"
...
# Incremental Compilation
    ...
    # incremental compilation will be enabled
     set Design_Name "udp_parser_top" 
